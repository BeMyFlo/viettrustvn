...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			...
			<div {...blockProps}>
				<div className="v-contact-hero__overlay">
					<div className="v-contact-hero__container">
						<div className="v-contact-hero__breadcrumbs">
							<span>Trang chủ</span> <span className="sep">/</span> <span className="active">Liên hệ</span>
						</div>
						<RichText
							tagName="h1"
							className="v-contact-hero__title"
							value={title}
							onChange={(val) => setAttributes({ title: val })}
							placeholder="LIÊN HỆ"
						/>
						<div className="v-contact-hero__subtitle-wrap">
							<RichText
								tagName="p"
								className="v-contact-hero__subtitle"
								value={subtitle}
