...
/**
 * Add child theme editor styles so styles like margin resets and colors
 * show up properly inside the block editor workspace.
 */
add_action('after_setup_theme', function (): void {
    ...
    if (!empty($manifest[$entry]['file'])) {
        add_editor_style('assets/dist/' . $manifest[$entry]['file']);
    } else {
        add_editor_style('assets/dist/css/child-style.css');
    }
});
...
// Register custom block category for Viettrust VN
...
// =============================================================================
// Register Custom Post Type: Services & Taxonomy: Service Groups
// =============================================================================

add_action('init', function (): void {
    register_post_type('viettrust_service', [
        'labels' => [
            'name'               => 'Dịch vụ',
        ...
        'template'           => [
            ['ai-zippy-child/viettrust-service-banner', ['align' => 'full']],
            ['ai-zippy-child/viettrust-service-intro', ['align' => 'full']],
            ['ai-zippy-child/viettrust-image-text', [
                'align' => 'full',
                'tagline' => 'GIẢI PHÁP CHẤT LƯỢNG',
                'title' => 'Vận hành chuyên nghiệp & minh bạch',
                'description' => 'Với đội ngũ nhân viên giàu kinh nghiệm và tâm huyết, chúng tôi tiến hành triển khai các phương án quản lý tài sản theo tiêu chuẩn quốc tế cùng hệ thống quản lý chi phí chặt chẽ.',
                'btnText' => '',
                'imagePosition' => 'left'
            ]],
            ['ai-zippy-child/viettrust-solutions-grid', ['align' => 'full']]
        ],
        'template_lock'      => false,
    ]);

    // Register Custom Taxonomy: Nhóm dịch vụ
    register_taxonomy('viettrust_service_group', 'viettrust_service', [
        'labels' => [
            'name'              => 'Nhóm dịch vụ',
            'singular_name'     => 'Nhóm dịch vụ',
            'search_items'      => 'Tìm nhóm dịch vụ',
            'all_items'         => 'Tất cả nhóm dịch vụ',
            'parent_item'       => 'Nhóm dịch vụ cha',
            'parent_item_colon' => 'Nhóm dịch vụ cha:',
            'edit_item'         => 'Sửa nhóm dịch vụ',
            'update_item'       => 'Cập nhật nhóm dịch vụ',
            'add_new_item'      => 'Thêm nhóm dịch vụ mới',
            'new_item_name'     => 'Tên nhóm dịch vụ mới',
